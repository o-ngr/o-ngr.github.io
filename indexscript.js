/* ═══════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════ */
const LINKS = [
  { id:1, title:'Latest News',         desc:'最新情報を確認できます',         url:'/ms05/page/news.html',        category:'extra' },
  { id:2, title:'Game List',           desc:'公開中のゲーム一覧',             url:'/ms05/page/gamelist.html',    category:'tools' },
  { id:3, title:'Tool List',           desc:'公開中のツール一覧',             url:'/ms05/page/toollist.html',    category:'tools' },
  { id:4, title:'Article List',        desc:'公開中の記事一覧',               url:'/ms05/page/articlelist.html', category:'tools' },
  { id:5, title:'Notepad app',         desc:'高機能なメモ帳',                 url:'/ms05/tools/notepad.html',    category:'tools' },
  { id:6, title:'Source code viewer',  desc:'ソースコードを確認',             url:'/ms05/tools/sauceview.html',  category:'tools' },
  { id:7, title:'Proxy tool',          desc:'プロキシ通信が可能',             url:'/ms05/tools/proxy.html',      category:'tools' },
  { id:8, title:'Link collection',     desc:'ショートカット一覧 (外部)',       url:'https://a-b-c.3do1.jp/', category:'tools' },
  { id:9, title:'Link collection 2',   desc:'ショートカット一覧',             url:'/ms05/page/links.html',       category:'tools' },
];
